...
- (void)viewDidLoad
{
	...
	self.title = @"Pending Inventories";
...
- (void)viewWillAppear:(BOOL)animated {
	...
	//[theRootViewController createToolbarItems:@"PENDING"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if (cell == nil) 
	{ 
		/*cell = [[[UITableViewCell alloc] initWithFrame:CGRectMake(50,10, 320, 78) 
