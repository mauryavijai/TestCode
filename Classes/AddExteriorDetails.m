...
@implementation AddExteriorDetails
...
- (void)viewDidLoad {
	...
	if (self.Mode == @"GARDEN") {
		self.title = @"Add Garden";
	}
	else if (self.Mode == @"GARAZE") {
		self.title = @"Add Garaze";
	}
	else if (self.Mode == @"BALCONY") {
		self.title = @"Add Balcony";
	}
